...
export const events: Event[] = [
  // DAY 1 - March 11, 2026 - Morning Events (9:30 AM)
  {
    id: 'thaka-dhimi-tha',
    name: 'Thaka Dhimi Tha (Solo Classical Dance)',
    category: 'Cultural',
    categoryId: 'cultural',
  ...
  {
    id: 'bhava-taranga',
    name: 'Bhava Taranga (Solo Singing)',
    category: 'Cultural',
    categoryId: 'cultural',
  ...
  {
    id: 'grove-gala',
    name: 'Grove Gala (Group Western Dance)',
    category: 'Cultural',
    categoryId: 'cultural',
  ...
  {
    id: 'who-am-i',
    name: 'Who Am I (Face Painting)',
    category: 'Cultural',
    categoryId: 'cultural',
    description: 'Creative face painting competition showcasing artistic skills and imagination.',
    rules: [
  ...
  {
    id: 'hands-of-art',
    name: 'Hands of Art (Mehandi)',
    category: 'Cultural',
    categoryId: 'cultural',
    description: 'Traditional mehndi/henna art competition with intricate designs.',
    rules: [
  ...
  // DAY 1 - Evening Events (2:00 PM)
  {
    id: 'standup-comedy',
    name: 'Standup Comedy',
    category: 'Cultural',
    categoryId: 'cultural',
    description: 'Stand-up comedy competition for aspiring comedians to showcase their humor.',
    rules: [
      'Solo performance',
  ...
  {
    id: 'janapada-nada',
    name: 'Janapada Nada (Group Singing)',
    category: 'Cultural',
    categoryId: 'cultural',
  ...
  {
    id: 'anime-arena',
    name: 'Anime Arena (Anime Quiz)',
    category: 'Cultural',
    categoryId: 'cultural',
    description: 'Anime quiz competition for anime enthusiasts. Prelims in CAED LAB (morning), Finals in Open Air Auditorium.',
    rules: [
      'Team of 2-3 members',
    ...
    date: 'March 11, 2026',
    time: '2:00 PM (Finals)',
    venue: 'Open Air Auditorium (Finals)',
  ...
  // DAY 2 - March 12, 2026 - Morning Events (9:30 AM)
  {
    id: 'musical-marathon',
    name: 'Musical Marathon (Antakshari)',
    category: 'Cultural',
    categoryId: 'cultural',
    description: 'Traditional antakshari competition testing musical knowledge and quick thinking.',
    rules: [
      'Team of 4-6 members',
    ...
    date: 'March 12, 2026',
    time: '9:30 AM',
    venue: 'Library Seminar Hall (Prelims) / Classrooms (Finals)',
  ...
  {
    id: 'natures-palette',
    name: "Nature's Palette (Flower Arrangement & Vegetable Carving)",
    category: 'Cultural',
    categoryId: 'cultural',
    description: 'Creative competition combining flower arrangement and vegetable carving skills.',
    rules: [
      'Team of 2 members',
      'Duration: 2 hours',
      'Materials provided',
  ...
  {
    id: 'kala-sangama',
    name: 'Kala Sangama (Variety Act)',
    category: 'Cultural',
    categoryId: 'cultural',
    description: 'Showcase your unique talent in this variety act competition - magic, mimicry, beatboxing, and more!',
    rules: [
  ...
  },
  {
    ...
    name: 'Bannada Prapancha (Rangoli)',
    category: 'Cultural',
    categoryId: 'cultural',
    description: 'Traditional rangoli competition showcasing colorful floor art.',
    rules: [
      'Team of 2 members',
      'Duration: 2.5 hours',
      'Area: 5x5 feet',
  ...
  {
    id: 'jam',
    name: 'JAM (Pick and Speech)',
    category: 'Cultural',
    categoryId: 'cultural',
    description: 'Just A Minute - impromptu speaking competition testing quick thinking and communication skills.',
    rules: [
      'Individual participation',
      'Topic given on spot',
  ...
  {
    id: 'art-of-tune',
    name: 'Art of Tune (Drawing)',
    category: 'Cultural',
    categoryId: 'cultural',
    description: 'Drawing competition to showcase artistic creativity and skill.',
    rules: [
      'Individual participation',
      'Duration: 2 hours',
  ...
  // DAY 2 - Later Events
  {
    ...
    name: 'Sketch Chronicles (Pencil Sketch)',
    category: 'Cultural',
    categoryId: 'cultural',
    description: 'Pencil sketching competition for artists to demonstrate their shading and detailing skills.',
    rules: [
      'Individual participation',
      'Duration: 2 hours',
  ...
  },
  {
    ...
    category: 'Cultural',
    categoryId: 'cultural',
    description: 'Mime performance competition - tell a story without words through expressions and gestures.',
    rules: [
