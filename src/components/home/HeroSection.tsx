  ...
  return (
    <span className={`relative inline-block ${className}`}>
      ...
      {isGlitching && (
        <>
          <span 
            className="absolute top-0 left-0 text-emerald-glow opacity-70 animate-pulse"
            style={{ 
          ...
          <span 
            className="absolute top-0 left-0 text-heritage-maroon opacity-70"
            style={{ 
...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    const eventDate = new Date('2026-03-11T09:00:00').getTime()
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 text-white/80 mb-10">
          <div className="flex items-center gap-2 glass-gold px-4 py-2 rounded-full">
            ...
            <span className="font-mono text-sm">March 11-14, 2026</span>
          </div>
          <div className="flex items-center gap-2 glass-gold px-4 py-2 rounded-full">
